...
uses
  ...
  FireDAC.Phys.PGDef, Backend.Controller.Pagamento, FireDAC.Phys.SQLite,
...
begin
  ...
  if aTopic = '/payment-response' then
    FControllerPagamento.PostPagamento(aMessage);
end;
...
begin
  ...
  Self.IcsMQTTClient1.Subscribe('/payment-response',qtAT_LEAST_ONCE);
end;
